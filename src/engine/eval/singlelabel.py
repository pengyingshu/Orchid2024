...
def compute_acc_auc(y_probs, y_true_ids, compute_f1 = False):
    ...
    if compute_f1:
        f1_micro, f1_macro = f1(y_probs, y_true_ids)
        return {"top1": top1, f"top{k}": top5, "f1_micro": f1_micro, "f1_macro": f1_macro}
    else:
