...
from .vit_lora.vit_mae import build_model as lora_mae_vit_model
MODEL_ZOO = {
    ...
    "swint_imagenet22k_224":  "swin_tiny_patch4_window7_224_22k.pth",
    "swins_imagenet22k_224":  "swin_small_patch4_window7_224_22k.pth",
...
def build_mae_model(
    model_type, crop_size, prompt_cfg, model_root, adapter_cfg=None, lora_cfg = None
):
    if prompt_cfg is not None:
        ...
        model = lora_mae_vit_model(model_type, lora_cfg)
    else:
...
def _build_prompted_swin_model(model_type, crop_size, prompt_cfg, model_root):
    ...
    elif model_type == "swint_imagenet22k_224":
        model = PromptedSwinTransformer(
            prompt_cfg,
            img_size=crop_size,
            embed_dim=96,
    ...
    elif model_type == "swins_imagenet22k_224":
            model = PromptedSwinTransformer(
                prompt_cfg,
                img_size=crop_size,
                embed_dim=96,
